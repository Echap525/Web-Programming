...
<head>
  ...
  <title> LOGIN WEBSITE RESTO PENJARA</title>
...
<body class="hold-transition login-page">
  <div class="login-box">
    < <div class="login-box-body">
      <h3>
        <center><strong>SELAMAT DATANG</strong></center>
      </h3>
      <h4>
        <center><strong>RESTO PENJARA</strong></center>
      </h4>
      <h5>
        <center><strong>MAKAN RASA TAHANAN</strong></center>
      </h5>
