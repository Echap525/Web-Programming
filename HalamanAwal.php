        ...
        <div class="col-md-8">
          ...
          <div class="box box-primary">
            <div class="box-body">
              ...
              <h2 class="page-header">SILAHKAN PILIH MENU MAKANAN ANDA</h2>
                  ...
                  <div class="box-body">
                   ...
                   order by a.tgl asc");
                          ...
                          ?>
                            <tr>
                              <!-- <td><?php echo "$no" ?></td> -->
                              <td><a href="?customer.php&act=delete&id=<?php echo $r['id_trans'] ?>"><button type="button" class="btn btn-info" onclick="return confirm('Apakah anda yakin akan menghapusnya?');"><i class="fa fa-trash-o"></i></button></a></td>
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-12 ">
                        ...
                        <button $status="sudah bayar" type="submit" name='add' class="btn btn-danger">Simpan Pesanan</button>
                        &nbsp;
                        <button $status="sudah bayar" type="submit" name='update_pesanan' class="btn btn-success">Update Pesanan</button>
