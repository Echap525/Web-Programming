...
<table border='0' align='LEFT'>
    <tr>
        ...
        <th width="900px" align="left">
            <h2>
                <left> LAPORAN PENJUALAN RESTO PENJARA<br> </left>
...
<br>
<h3 style="text-align:center;"> LAPORAN PENJUALAN RESTO PENJARA </h3>
...
<table border='0' align='right'>
    <tr>
        ...
        <th><?php
            ...
            ?>
            <p style="margin: 50px 8px 5px 420px;"> JAKARTA, <?php echo "$tanggal" ?>
            <h4>
                <center> </center>
            </h4>
            <br>
